      ...
      <DialogContent className="max-h-[90dvh] overflow-y-auto overscroll-contain touch-pan-y">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor={`report-modal-reason-${linkId}`} className="text-sm font-medium">
              Motivo da denúncia
            </label>
            <Textarea
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                {errors.motivo?.message && <p className="text-sm text-destructive">{errors.motivo.message}</p>}
