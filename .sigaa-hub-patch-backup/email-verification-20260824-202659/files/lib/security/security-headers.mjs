...
export function buildSecurityHeaders(environment = process.env) {
  return [
    ...
    {
      key:
        environment.SECURITY_CSP_MODE?.trim().toLowerCase() === "enforce"
